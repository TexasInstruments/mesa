...
#define __DRI_IMAGE_FORMAT_NV12         PIPE_FORMAT_NV12
#define __DRI_IMAGE_FORMAT_NV21         PIPE_FORMAT_NV21
#define __DRI_IMAGE_FORMAT_IYUV         PIPE_FORMAT_IYUV
#define __DRI_IMAGE_FORMAT_YV12         PIPE_FORMAT_YV12
#define __DRI_IMAGE_FORMAT_YVYU         PIPE_FORMAT_YVYU
#define __DRI_IMAGE_FORMAT_VYUY         PIPE_FORMAT_VYUY
